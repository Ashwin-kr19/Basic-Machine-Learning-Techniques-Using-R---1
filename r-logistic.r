...
# train_inputs %in% remove
# remove

# categorical_cols = train_inputs[! train_inputs %in% remove]

# i = 0
# for (var in colnames(train_inputs))
# {
#     if(var in numeric)
# }
# categorical_cols = colnames(categorical_cols)
# categorical_cols
...
# train_inputs %>% select(numeric_cols)
# View(train_inputs %>% select(numeric_cols))
...
# train_inputs$Evaporation = range01(train_inputs$Evaporation)
